...
export const get_all_collection_project = async (isCollection: 0 | 1): Promise<ProjectInfo[]> => {
    const {data} = (await ipcInstance.send<string>(channels.auxiliaryDb.projectInfo.getAllCollectionProject, isCollection))
    return data
}
